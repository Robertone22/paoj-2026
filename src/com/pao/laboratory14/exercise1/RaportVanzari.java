...
public class RaportVanzari {
    ...
    public RaportVanzari(
        ...
        this.numarPerTip = Collections.unmodifiableMap(new LinkedHashMap<>(numarPerTip));
        this.incasariPerTip = Collections.unmodifiableMap(new LinkedHashMap<>(incasariPerTip));
